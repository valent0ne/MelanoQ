...
const actions = {
  [INSERT_C1](context, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.post("questionnaire/" + context.getters.dbCodeNumber + "/c1", payload)
        .then(({ data }) => {
  ...
  [UPDATE_C1](context, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.setHeader(context.getters.currentUser.token)
      ApiService.patch("questionnaire/" + context.getters.dbCodeNumber + "/c1", payload)
        .then(({ data }) => {
          if (data.error || data.data == null) {
            throw data
          }
  ...
  [DELETE_C1](context) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.setHeader(context.getters.currentUser.token)
      ApiService.delete("questionnaire/" + context.getters.dbCodeNumber + "/c1", {})
        .then(({ data }) => {
          if (data.error || data.data == null) {
            throw data
          }
