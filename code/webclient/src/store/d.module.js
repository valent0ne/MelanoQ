...
const actions = {
  [INSERT_D](context, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.post("questionnaire/" + context.getters.dbCodeNumber + "/d", payload)
        .then(({ data }) => {
  ...
  [UPDATE_D](context, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.setHeader(context.getters.currentUser.token)
      ApiService.patch("questionnaire/" + context.getters.dbCodeNumber + "/d", payload)
        .then(({ data }) => {
          if (data.error || data.data == null) {
            throw data
          }
  ...
  [DELETE_D](context) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.setHeader(context.getters.currentUser.token)
      ApiService.delete("questionnaire/" + context.getters.dbCodeNumber + "/d", {})
        .then(({ data }) => {
          if (data.error || data.data == null) {
            throw data
          }
