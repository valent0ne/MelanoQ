...
const actions = {
  [INSERT_B3](context, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.post("questionnaire/" + context.getters.dbCodeNumber + "/b3", payload)
        .then(({ data }) => {
  ...
  [UPDATE_B3](context, payload) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.setHeader(context.getters.currentUser.token)
      ApiService.patch("questionnaire/" + context.getters.dbCodeNumber + "/b3", payload)
        .then(({ data }) => {
          if (data.error || data.data == null) {
            throw data
          }
  ...
  [DELETE_B3](context) {
    ...
    return new Promise((resolve, reject) => {
      ...
      ApiService.setHeader(context.getters.currentUser.token)
      ApiService.delete("questionnaire/" + context.getters.dbCodeNumber + "/b3", {})
        .then(({ data }) => {
          if (data.error || data.data == null) {
            throw data
          }
